      ...
      <div class="table-responsive cart_info"> 
              ...
              ?>
                         ...
                         <!-- <td></td> -->
                          ...
                          <td>&#8369 <?php  echo number_format($result->PRODISPRICE); ?></td>
                                    ...
                                    <div class="form-group ">
                                      <label>Address where to deliver (Around Pangasinan Only)</label>
                                        ...
                                        <div class="col-md-12">
                                          ...
                                          <div class="col-md-8">
                                           <input class="form-control paymethod" name="BRGY" id="BRGY" value=" <?php echo $singlecustomer->STREETADD;?>"onchange="validatedate()">
                                                                                ...
                                                                                <div class="col-md-12">
                                          <label class="col-md-4 control-label" for=
                                          "BRGY">Home Number</label>

                                          <div class="col-md-8">
                                           <input class="form-control paymethod" name="BRGY" id="BRGY" value=" <?php echo $singlecustomer->CUSHOMENUM;?>"onchange="validatedate()">
