...
?>
 	 <h4>Your order has been confirmed</h4><br/>
 		<h5>DEAR Ma'am/Sir ,</h5>
...
}elseif($cur->ORDEREDSTATS=='Unverified'){

	 echo "Your order has been cancelled due to account need to verify.";
...
elseif($cur->ORDEREDSTATS=='Shipped'){
	echo "<h5>Your order is on the way. Please prepare exact ammount of money and check your profile for notification of confirmation.</h5>";
}
elseif($cur->ORDEREDSTATS=='Delivered'){
		 
?>
 	 <h4>Your order has been Delivered</h4><br/>
 		<h5>DEAR Ma'am/Sir ,</h5>
		<h5>Your order is Delivered Successfuly! As you have ordered via Cash on Delivery, Thankyou!.	</h5>
		 <hr/>
		 <h4><strong>Delivery Information</strong></h4>
		 <div class="row">
		 	<div class="col-md-6">
		...
		?>
 		...
 		<div class="row">
		  ...
		  <div class="row">
		  	  ...
		  	  <p>Sincerely.</p>
		  	  		  	  <p>IT MAN ADMIN</p>
		  	  <h4><a href="###">Thenmarck Dulos</a></h4>
		  </div>
		  <?php }?>
  </div> 
